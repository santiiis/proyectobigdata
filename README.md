...
<ul>
  ...
  <li>
    ...
    Alcanzar un <strong>AUC-ROC &ge; 0.80</strong> y un 
...
<table width="100%" border="1" cellpadding="6" cellspacing="0">
  <thead>
    <tr bgcolor="#f2f2f2">
      ...
      <th align="left">Detalle Técnico</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td>Registros descartados por inconsistencias</td>
      <td align="center"><strong>2,273</strong></td>
      <td>Depuración de fechas y datos atípicos operacionales</td>
    </tr>
    <tr>
      <td>Registros finales procesados</td>
      <td align="center"><strong>30,320</strong></td>
      <td>100% de consistencia relacional tras ETL</td>
    </tr>
    <tr>
      <td>Optimización de almacenamiento</td>
      <td align="center"><strong>68.5%</strong></td>
      <td>Reducción de tamaño en disco a formato Parquet</td>
    </tr>
  </tbody>
</table>
...
<p>
  ...
  <strong>ParamGridBuilder</strong>, registrando parámetros y métricas en <strong>MLflow Tracking</strong>:
</p>
...
<table width="100%" border="1" cellpadding="6" cellspacing="0">
  ...
  <tbody>
    <tr bgcolor="#e6f3ff">
      ...
      <td align="center"><strong>0.8480</strong></td>
      <td align="center"><strong>0.7994</strong></td>
...
<p>
  ...
  <strong>AUC-ROC (0.8480)</strong> y el mayor <strong>F1-Score (0.7994)</strong> en el conjunto de prueba independiente. 
  Al optimizar árboles de decisión de forma secuencial mediante gradiente descendente, GBT modela con mayor precisión interacciones no lineales entre los patrones de navegación y los antecedentes académicos, superando en balance a la Regresión Logística y a Random Forest.
</p>
...
<blockquote>
  ...
  El <strong>74.28%</strong> del poder explicativo del modelo reside en el volumen de interacción en el LMS (<code>sum_click</code>), complementado por la carga crediticia matriculada (<strong>12.80%</strong>) y la antelación en matrícula (<strong>9.02%</strong>).
</blockquote>
...
<p>
  ...
  <strong>615 registros estadísticamente atípicos</strong> en la población limpia evaluada.
</p>
<p>
  Estos casos correspondieron a estudiantes con niveles de actividad estadísticamente extremos respecto a la distribución general, los cuales fueron identificados y aislados para evaluar su posible impacto en la estabilidad numérica del modelo sin alterar el entrenamiento distribuido.
</p>
...
<ul>
  <li><strong>Completitud:</strong> 99.8% tras imputación determinista de nulos en el flujo ETL.</li>
  ...
  <li><strong>Exactitud:</strong> Depuración estricta de 2,273 registros fuera de rangos operacionales.</li>
...
<ul>
  ...
  <li><strong>Principio de finalidad:</strong> Uso exclusivo para soporte psicopedagógico y bienestar estudiantil institucional.</li>
</ul>
