...
<p>
  ...
  <b>Tema Asignado:</b> Predicción de Deserción Estudiantil (Grupo 7)
</p>
...
<p>
  La deserción universitaria temprana compromete la continuidad pedagógica y la sostenibilidad institucional. El seguimiento tradicional detecta la desconexión del estudiante de manera reactiva, una vez que las calificaciones finales han sido publicadas.
</p>
<ul>
...
<p>
  Tablas integradas en el pipeline: <code>studentInfo.csv</code>, <code>studentRegistration.csv</code> y <code>studentVle.csv</code>.
</p>
...
<p>Procesamiento sobre <b>32,593 registros estudiantiles</b> en PySpark:</p>
<ol>
  <li><b>Filtrado temporal:</b> Descarte de inconsistencias en <code>date_registration</code> fuera del rango [-150, +30] días respecto al inicio del curso.</li>
...
<ul>
  <li><b>Telemetría en campus virtual (<code>sum_click</code>):</b> 46.8%</li>
...
<h2>🛡️ 6. Gobierno de Datos y Auditoría Ética</h2>
<ul>
...
cd proyectobigdata</code></pre>
  ...
  <li>
    Abrir el notebook <code>notebooks/notebook_integrador_bigdata.ipynb</code> en <b>Google Colab</b>.
  </li>
  <li>
